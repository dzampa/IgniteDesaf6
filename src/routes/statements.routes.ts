...
import { CreateStatementTransfController } from '../modules/statements/useCases/createStatementTransf/CreateStatementTransfController';
...
const createStatementTransfController = new CreateStatementTransfController();
...
statementRouter.post('/transfers/:user_id', createStatementTransfController.execute);
